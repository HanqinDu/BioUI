...
<body>
<h4>Blastp against JZZ database: a collection of genome data obtained from JZZ</h4>
...
<form action="BlastpJZZListener" method="post" enctype="multipart/form-data" onsubmit="disabledSubmit();">
...
<datalist id="mode">
	<option value="blastp">
	<option value="blastp-fast">
	<option value="blastp-short">
</datalist>
<br>
...
Expect evalue: <input name="evalue" list="evalue">
<datalist id="evalue">
...
Matrix: <input name="matrix" list="matrix">
<datalist id="matrix">
	<option value="default">
...
Length of initial exact match: <input name="word_size" list="word_size">
<datalist id="word_size">
	<option value="default">
...
<br>
* the filename should be not longer than 42 characters (exclude filename extension)
<br>

*Upload query sequences(.faa): <input multiple type="file" name="input1">
<br>
<br>

*Target database: <input name="targetdb" list="targetdb" onchange="expandUpload(this)">
<datalist id="targetdb">
	<option value="JZZ database">
	<option value="green lab marker">
	<option value="custom database">
</datalist>
<br>

Upload customized protein database (optional): <input multiple type="file" name="input2" id="input2">
...
<script type="text/javascript">
	...
	function expandUpload(input){
		if(input.value == "custom database"){
