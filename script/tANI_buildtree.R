...
ANI_orig_file <- "Distance_orig.orig"
...
pdf(file="../Rplot.pdf", width = 10 + length(ANI_orig_diag) * 0.2, height = 10 + length(ANI_orig_diag) * 0.2)
plot(tree_orig)
...
plotBS(tree_orig,bs_trees,p=1, type="phylogram")
